...
#ifndef BlynkSimpleEsp32_Async_WM_h
#define BlynkSimpleEsp32_Async_WM_h

#ifndef ESP32
  #error This code is intended to run on the ESP32 platform! Please check your Tools->Board setting.
#endif

#define BLYNK_ASYNC_WM_VERSION      "Blynk_Async_WM for ESP32 v1.3.0"
...
// But if not specified any, use SPIFFS to not forcing user to install LITTLEFS library
  ...
  #warning Using LittleFS in BlynkSimpleESP32_Async_WM.h
#elif USE_SPIFFS
  #include "FS.h"
  #include <SPIFFS.h>
  FS* filesystem =      &SPIFFS;
  #define FileFS        SPIFFS
  #warning Using SPIFFS in BlynkSimpleESP32_Async_WM.h
#else
  #include <EEPROM.h>
  #warning Using EEPROM in BlynkSimpleESP32_Async_WM.h
#endif
...
const char BLYNK_WM_HTML_HEAD_START[] /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>BlynkSimpleEsp32_Async_WM</title>";
      ...
      if (request)
      {
        ...
        if (key == "" && value == "")
        {
          ...
          if ( RFC952_hostname[0] != 0 )
          {
            ...
            result.replace("BlynkSimpleEsp32_Async_WM", RFC952_hostname);
          }
          else if ( BlynkESP32_WM_config.board_name[0] != 0 )
          {
            // Or replace only if board_name is valid.  Otherwise, keep intact
            result.replace("BlynkSimpleEsp32_Async_WM", BlynkESP32_WM_config.board_name);
          }
...
#endif    // BlynkSimpleEsp32_Async_WM_h
